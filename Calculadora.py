...
print("Masa corporal es: " + str(IMC))


if IMC >= 0 and IMC <= 18.9:
   print("Estas en peso bajo " + str(nombre1) + " a tu edad de " + str(edad) + ", deberias comer un poco mas por que tienes delgadez extrema") 
   
elif IMC >= 19 and IMC <= 24.99:
 print("Hola  " + str(nombre1) + " a tu edad de " + str(edad) + " años"  ", te encunetras en peso normal, sigue alimentandote sanamente")
